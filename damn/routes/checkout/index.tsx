...
const CheckoutContent = component$(() => {
  ...
  const placeOrder = $(async () => {
    ...
    try {
      ...
      // Address submission and shipping method setting is now handled directly by CheckoutAddresses component
      // No need to set shipping method again as it's managed by CheckoutOptimizationService
