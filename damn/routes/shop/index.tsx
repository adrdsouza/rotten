   ...
   <div class="grid grid-cols-2 gap-3 sm:gap-6 lg:grid-cols-3 xl:grid-cols-4">
    {displayProducts.length === 0 ? (
     ...
     {displayProducts.map((item, index) => {
        // 🚀 OPTIMIZED: Hybrid approach for optimal performance
        // First 4 items: Use regular ProductCard for immediate above-the-fold loading
        // Items 5+: Use ViewportLazyProductCard for memory-efficient lazy loading
