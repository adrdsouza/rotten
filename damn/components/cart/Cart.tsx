import { component$, useContext, useSignal, useStore, $, useResource$, Resource, useVisibleTask$ } from '@qwik.dev/core';
...
export default component$(() => {
	...
	// Dropdown state for debouncing country selection
	...
	useVisibleTask$(() => {
		console.log('Cart: Available countries:', appState.availableCountries.length, appState.availableCountries.slice(0, 3));
	});
