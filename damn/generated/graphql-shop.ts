...
export type Mutation = {
  ...
  verifySezzlePayment: SezzleVerificationResult;
};
...
export type MutationVerifySezzlePaymentArgs = {
...
export type ProductVariantCustomFields = {
  ...
  preOrderPrice?: Maybe<Scalars['Int']['output']>;
...
export type SezzleVerificationResult = {
  __typename?: 'SezzleVerificationResult';
  message: Scalars['String']['output'];
  success: Scalars['Boolean']['output'];
};
...
export type ActiveCustomerOrdersQuery = { __typename?: 'Query', activeCustomer?: { __typename?: 'Customer', id: string, orders: { __typename?: 'OrderList', totalItems: number, items: Array<{ __typename?: 'Order', id: string, code: string, state: string, createdAt: any, orderPlacedAt?: any | null, updatedAt: any, totalWithTax: any, subTotalWithTax: any, shippingWithTax: any, currencyCode: CurrencyCode, couponCodes: Array<string>, customer?: { __typename?: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string } | null, shippingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null } | null, billingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null } | null, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any, shippingMethod: { __typename?: 'ShippingMethod', id: string, name: string, description: string } }>, fulfillments?: Array<{ __typename?: 'Fulfillment', id: string, state: string, method: string, trackingCode?: string | null, createdAt: any, updatedAt: any, lines: Array<{ __typename?: 'FulfillmentLine', orderLineId: string, quantity: number }> }> | null, payments?: Array<{ __typename?: 'Payment', id: string, method: string, amount: any, state: string, transactionId?: string | null, createdAt: any, metadata?: any | null }> | null, lines: Array<{ __typename?: 'OrderLine', id: string, quantity: number, unitPriceWithTax: any, linePriceWithTax: any, discountedUnitPriceWithTax: any, discountedLinePriceWithTax: any, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, productVariant: { __typename?: 'ProductVariant', id: string, name: string, sku: string, price: any, customFields?: { __typename?: 'ProductVariantCustomFields', salePrice?: number | null, preOrderPrice?: number | null, shipDate?: string | null } | null, options: Array<{ __typename?: 'ProductOption', name: string }>, product: { __typename?: 'Product', id: string, name: string, slug: string } } }>, discounts: Array<{ __typename?: 'Discount', type: AdjustmentType, description: string, amountWithTax: any }>, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxTotal: any }> }> } } | null };
...
export type VerifySezzlePaymentMutationVariables = Exact<{
  orderCode: Scalars['String']['input'];
}>;


export type VerifySezzlePaymentMutation = { __typename?: 'Mutation', verifySezzlePayment: { __typename?: 'SezzleVerificationResult', success: boolean, message: string } };

export type CustomOrderDetailFragment = { __typename: 'Order', id: string, code: string, active: boolean, createdAt: any, state: string, currencyCode: CurrencyCode, couponCodes: Array<string>, totalQuantity: number, subTotal: any, subTotalWithTax: any, shippingWithTax: any, totalWithTax: any, discounts: Array<{ __typename?: 'Discount', type: AdjustmentType, description: string, amountWithTax: any }>, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxTotal: any }>, customer?: { __typename?: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string } | null, shippingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, company?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null } | null, billingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, company?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null } | null, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any, shippingMethod: { __typename?: 'ShippingMethod', id: string, name: string } }>, lines: Array<{ __typename?: 'OrderLine', id: string, unitPriceWithTax: any, linePriceWithTax: any, quantity: number, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, productVariant: { __typename?: 'ProductVariant', id: string, name: string, price: any, stockLevel: string, customFields?: { __typename?: 'ProductVariantCustomFields', salePrice?: number | null, preOrderPrice?: number | null, shipDate?: string | null } | null, options: Array<{ __typename?: 'ProductOption', id: string, code: string, name: string, group: { __typename?: 'ProductOptionGroup', id: string, name: string } }>, product: { __typename?: 'Product', id: string, name: string, slug: string } } }>, payments?: Array<{ __typename?: 'Payment', id: string, method: string, amount: any, state: string, transactionId?: string | null, metadata?: any | null }> | null };
...
export type DetailedProductFragmentFragment = { __typename?: 'Product', id: string, name: string, slug: string, description: string, facetValues: Array<{ __typename?: 'FacetValue', id: string, code: string, name: string, facet: { __typename?: 'Facet', id: string, code: string, name: string } }>, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, assets: Array<{ __typename?: 'Asset', id: string, preview: string }>, variants: Array<{ __typename?: 'ProductVariant', id: string, name: string, priceWithTax: any, currencyCode: CurrencyCode, sku: string, stockLevel: string, customFields?: { __typename?: 'ProductVariantCustomFields', salePrice?: number | null, preOrderPrice?: number | null, shipDate?: string | null } | null }> };

export type VariantStockFragmentFragment = { __typename?: 'Product', id: string, variants: Array<{ __typename?: 'ProductVariant', id: string, name: string, stockLevel: string, priceWithTax: any, currencyCode: CurrencyCode, customFields?: { __typename?: 'ProductVariantCustomFields', salePrice?: number | null, preOrderPrice?: number | null, shipDate?: string | null } | null }> };

export type ListedProductFragment = { __typename?: 'SearchResult', productId: string, productName: string, slug: string, inStock: boolean, productAsset?: { __typename?: 'SearchResultAsset', id: string, preview: string } | null, priceWithTax:
...
export type ProductVariantsQuery = { __typename?: 'Query', product?: { __typename?: 'Product', id: string, variants: Array<{ __typename?: 'ProductVariant', id: string, name: string, stockLevel: string, priceWithTax: any, currencyCode: CurrencyCode, customFields?: { __typename?: 'ProductVariantCustomFields', salePrice?: number | null, preOrderPrice?: number | null, shipDate?: string | null } | null }> } | null };
...
export type SearchQuery = { __typename?: 'Query', search: { __typename?: 'SearchResponse', totalItems: number, items: Array<{ __typename?: 'SearchResult', productId: string, productName: string, slug: string, inStock: boolean, productAsset?: { __typename?: 'SearchResultAsset', id: string, preview: string } | null, priceWithTax:
        | { __typename?: 'PriceRange', min: any, max: any }
        | { __typename?: 'SinglePrice', value: any }
       }> } };
...
export const ErrorResultFragmentDoc = gql`
  ...
  __typename
    ...
    `;
export const CustomOrderDetailFragmentDoc = gql`
  ...
  payments {
    ...
    `;
export const DetailedProductFragmentFragmentDoc = gql`
  ...
  variants {
    ...
    `;
export const VariantStockFragmentFragmentDoc = gql`
...
export const ValidateLocalCartCouponDocument = gql`
  ...
  validateLocalCartCoupon(input: $input) {
    ...
    `;
export const VerifySezzlePaymentDocument = gql`
...
export const ProductDocument = gql`
  ...
  product(slug: $slug, id: $id) {
    ...
    ${DetailedProductFragmentFragmentDoc}`;
export const ProductVariantsDocument = gql`
  ...
  product(slug: $slug, id: $id) {
    ...
    ${VariantStockFragmentFragmentDoc}`;
...
export function getSdk<C>(requester: Requester<C>) {
  return {
    ...
    verifySezzlePayment(variables: VerifySezzlePaymentMutationVariables, options?: C): Promise<VerifySezzlePaymentMutation> {
      return requester<VerifySezzlePaymentMutation, VerifySezzlePaymentMutationVariables>(VerifySezzlePaymentDocument, variables, options) as Promise<VerifySezzlePaymentMutation>;
    },
    ...
    productVariants(variables?: ProductVariantsQueryVariables, options?: C): Promise<ProductVariantsQuery> {
      return requester<ProductVariantsQuery, ProductVariantsQueryVariables>(ProductVariantsDocument, variables, options) as Promise<ProductVariantsQuery>;
    },
