...
chown -R vendure:vendure /home/vendure/damneddesigns/backend/logs
chmod 750 /home/vendure/damneddesigns/backend/logs

# Create logrotate configuration
cat > /etc/logrotate.d/vendure-logs << 'EOL'
/home/vendure/damneddesigns/backend/logs/*.log {
    daily
    missingok
    rotate 30
    compress
...
echo "Logging setup complete. Logs will be stored in /home/vendure/damneddesigns/backend/logs/"
