...
mkdir -p /home/vendure/rottenhand/logs/backend

# Set appropriate permissions (adjust user:group as needed)
chown -R vendure:vendure /home/vendure/rottenhand/logs/backend
chmod 750 /home/vendure/rottenhand/logs/backend

# Create logrotate configuration
cat > /etc/logrotate.d/vendure-logs << 'EOL'
/home/vendure/rottenhand/logs/backend/*.log {
    daily
    missingok
    rotate 30
    compress
...
echo "Logging setup complete. Logs will be stored in /home/vendure/rottenhand/logs/backend/"
