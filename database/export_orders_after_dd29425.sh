...
# Script to export orders after DD29425
# Created on: 2025-07-16

# Set the output filename with today's date
OUTPUT_FILE="orders_after_dd29425_$(date +%Y-%m-%d).csv"
...
sudo -u postgres psql -d rotten_db -c "\copy (
    ...
    WHERE
        -- Filter for orders with code greater than DD29425
        CAST(SUBSTRING(o.code, 3) AS INTEGER) > 29425
    ORDER BY
