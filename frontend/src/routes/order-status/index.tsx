    ...
    return (
      <div class="min-h-screen bg-gray-50 flex items-center justify-center">
        <div class="text-center">
          <div class="animate-spin rounded-full h-8 w-8 border-b-2 border-[#eee9d4] mx-auto mb-4"></div>
      ...
      <div class="max-w-md w-full space-y-8">
        ...
        <div class="mt-8 space-y-4">
          <Link
            ...
            class="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-lg text-white bg-[#eee9d4] hover:bg-[#4F3B26] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#eee9d4] transition-colors"
          >
          ...
          <div class="text-center">
            ...
            <Link
              ...
              class="text-sm font-medium text-[#eee9d4] hover:text-[#4F3B26] transition-colors"
            >
              Create one here
            </Link>
          </div>
        ...
        <div class="mt-6 border-t border-gray-200 pt-6">
          <p class="text-xs text-gray-500 text-center">
            ...
            <a href="mailto:info@rottenhand.com" target='_blank' class="text-[#eee9d4] hover:text-[#4F3B26]">
              info@rottenhand.com
            </a>
          </p>
        </div>
