      ...
      <div class="bg-black/25 backdrop-blur-sm rounded-lg border border-white/15 text-center flex-1 flex flex-col justify-center p-8 lg:p-12">
        ...
        <div>
          <Link
            href="/shop"
            prefetch
            class="bg-[#e34545] hover:bg-[#d32f2f] text-white font-bold tracking-wide transition-all duration-300 transform hover:scale-105 uppercase rounded-lg shadow-lg cursor-pointer px-8 py-4 text-lg inline-block text-center"
          >
            VIEW COLLECTION →
          </Link>
        </div>
      ...
      <div class="bg-black/30 backdrop-blur-sm rounded-lg border border-white/10 flex-1 flex flex-col justify-center p-6 lg:p-8">
        ...
        <div class="flex flex-col lg:flex-row lg:justify-between lg:items-start lg:space-y-0 gap-6 lg:gap-8 mb-6">
          ...
          <div class="text-center lg:text-left">
            <div class="flex items-center justify-center lg:justify-start mb-4">
              <span class="font-bold text-white brand-text text-xl">Damned Designs</span>
            </div>
            {/* Social Media Section */}
            <div class="mb-3">
              <p class="font-medium text-gray-300 text-sm mb-3">Follow us on social media</p>
              <div class="flex justify-center lg:justify-start space-x-4">
                <a href="https://www.facebook.com/damneddesigns" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-white transition-colors group" aria-label="Follow us on Facebook">
                ...
                <a href="https://www.pinterest.com/damneddesigns/" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-white transition-colors group" aria-label="Follow us on Pinterest">
                  <svg class="group-hover:scale-110 transition-transform duration-200 w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://www.instagram.com/damneddesigns/" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-white transition-colors group" aria-label="Follow us on Instagram">
                  <svg class="group-hover:scale-110 transition-transform duration-200 w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="border-t border-white border-opacity-20 pt-4">
          <div class="text-center">
            <p class="text-gray-400 text-xs">© 2025 Damned Designs. All rights reserved.</p>
          </div>
        </div>
      </div>
    </>
