      ...
      <div class="bg-black/25 backdrop-blur-sm rounded-lg border border-white/15 text-center flex-1 flex flex-col justify-center p-8 lg:p-12">
        ...
        <div>
          <Link
            href="/shop"
            prefetch
            class="bg-[#8a6d4a] hover:bg-[#4F3B26] text-white font-bold tracking-wide transition-all duration-300 transform hover:scale-105 uppercase rounded-lg shadow-lg cursor-pointer px-8 py-4 text-lg inline-block text-center"
          >
            VIEW COLLECTION →
          </Link>
        </div>
