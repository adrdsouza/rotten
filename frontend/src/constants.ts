...
export const DEFAULT_METADATA_URL = 'https://rottenhand.com/';
export const DEFAULT_METADATA_TITLE = 'Rotten Hand';
export const DEFAULT_METADATA_DESCRIPTION =
	'Premium quality products and exceptional service at Rotten Hand';
