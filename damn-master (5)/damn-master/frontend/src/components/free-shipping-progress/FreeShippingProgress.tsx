...
export default component$<Props>(({ countryCode, orderTotalAfterDiscount }) => {
		...
		<div class="bg-amber-50 border border-amber-200 rounded-lg p-3 mb-4">
			<div class="flex items-center justify-between mb-2">
				...
				<span class="text-xs text-amber-700">
					{formatPrice(remainingAmount.value)} to go!
				</span>
			</div>
			...
			<p class="text-xs text-amber-700">
				Add <strong>{formatPrice(remainingAmount.value)}</strong> more to qualify for free shipping!
			</p>
		</div>
	);
});